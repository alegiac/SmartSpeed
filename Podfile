...
post_install do |installer|
  ...
  if Dir.exists?('SmartSpeed/Resources/Settings.bundle') && File.exists?(acknowledgements_plist)
    FileUtils.cp(acknowledgements_plist, 'SmartSpeed/Resources/Settings.bundle/Acknowledgements.plist')
  end
end
